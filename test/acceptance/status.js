...
describe('Status', function () {
  ...
  var bearerToken
  let statusConfigBackup = config.get('status')
  let urlConfigBackup = config.get('publicUrl')
  ...
  after(function (done) {
    ...
    config.set('status.requireAuthentication', statusConfigBackup.requireAuthentication)
