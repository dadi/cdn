...
describe('Cache', function() {
              ...
              client
                ...
                .end((err, res) => {
                  ...
                  config.set(
                    ...
                    configBackup.notFound.images.path
                  )
  ...
  describe('TTL', () => {
    it('should keep cached items for the period of time defined in caching.ttl', done => {
      const mockCacheGet = sinon.spy(cache.Cache.prototype, 'getStream')
      const mockCacheSet = sinon.spy(cache.Cache.prototype, 'cacheFile')
...
describe('Frequency cache flush', () => {
  ...
  describe('with multi-domain disabled', () => {
    it('should flush the entire cache in the interval defined by the `expireAt` property', done => {
      ...
      app.start(() => {
        const mockCacheDelete = sinon.spy(cache.Cache.prototype, 'delete')

        setTimeout(() => {
          mockCacheDelete.args
            .every(callArgs => {
